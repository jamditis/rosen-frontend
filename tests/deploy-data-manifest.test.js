...
const KNOWN_NOT_DEPLOYED = new Map([
  ...
  ['data/relationship-review-report.json',
    'curator review list of rows a "reviewed" relationship-type rule flags, ' +
    'regenerated by scripts/validate-graph-data.mjs (issue #868); no deployed ' +
    'page reads it'],
