...
| **Earliest Content** | 1986 dissertation |
| **Most Recent** | 2025 |
...
### Concept Adoption
His concept "The People Formerly Known as the Audience" shows:
- 59% grassroots individual adoption
- 23% organizational adoption
- Prominence score: 10/10

### Most Connected
Jay Rosen appears in **1,428 entity connections** across the archive.

---

## Jay Rosen: Quick Bio

- **Position:** Professor of Journalism, NYU (since 1986)
- **Education:** Ph.D., New York University, 1986
- **Dissertation:** "The Impossible Press" (advisor: Neil Postman)
- **Key Book:** "What Are Journalists For?" (Yale, 1999)
- **Blog:** PressThink.org (founded 2003)
...
| **Significance** | First public release; intellectual foundation for 40 years of criticism |
...
| | |
|---|---|
| **Data Processing** | Python + Google Gemini AI |
| **Search** | Full-text across all records |
