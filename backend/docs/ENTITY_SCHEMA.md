...
The entity extraction system uses Google Gemini AI to automatically identify and categorize named entities (people, organizations, works, concepts, events, locations) and their relationships from text content in Jay Rosen's Internet Archive.
