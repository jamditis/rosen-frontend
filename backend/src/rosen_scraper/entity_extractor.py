...
from text content in the Jay Rosen Digital Archive. It identifies people,
...
def extract_entities_and_relationships(
    ...
    prompt = f"""
**INSTRUCTIONS:**
You are a specialized entity extraction AI for the Jay Rosen Digital Archive. Your task is to analyze journalism and media criticism texts to extract:
