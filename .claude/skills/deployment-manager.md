...
The Jay Rosen Digital Archive deploys to WordPress via FTP with absolute paths. This skill manages the transition between local development and production paths.
