...
const Sidebar: React.FC<SidebarProps> = ({ facets, filters, setFilters, isOpen, onClose, resetFilters, autocompleteIndex }) => {
                ...
                {facets.categories.length > 10 && (
                    ...
                    >
                        {showAllCategories ? (
                             ...
                             <>View All ({facets.categories.length - 10} more) <ChevronDown className="w-3 h-3"/></>
                        )}
                    </button>
                )}
             </div>
