...
This document outlines the product requirements for the "Enhanced data dashboard," a web-based, interactive tool for the exploration and analysis of Jay Rosen's Internet Archive. The archive contains a curated collection of writings, interviews, and other works by journalism professor Jay Rosen.
