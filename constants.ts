...
import { ThemeColor, FeaturedWork } from './types';
...
export const DATA_CONFIG = {
    ...
    social_posts: `${SHEET_BASE}?gid=123456789&single=true&output=csv`, // REPLACE WITH REAL GID
    entities: `${SHEET_BASE}?gid=0&single=true&output=csv`,          // REPLACE WITH REAL GID
    relationships: `${SHEET_BASE}?gid=0&single=true&output=csv`      // REPLACE WITH REAL GID
};

export const CSV_URL = DATA_CONFIG.test_runs; // Fallback
...
export const FEATURED_WORKS: FeaturedWork[] = [
  {
    ...
    link: 'https://drive.google.com/file/d/14sIj3nYzOaV_CRHLMRvbgv9EcYbCsp4L/view?usp=sharing',
