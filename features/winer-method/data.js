...
export const RECORDS = freeze([
  ...
  },
  {
    ...
    summary: 'Responding to a familiar critique of blogs, Winer reverses the frame: a blogger can be the source speaking in public rather than a writer citing one. This curated trail treats that distinction as a precursor to the later formulation.',
  ...
  },
  {
    ...
    summary: 'Winer includes “Sources go direct” among the enduring mottos that orient his work. On the same page he credits Rosen’s thinking about voice and authority. The exchange runs in both directions.',
    themes: ['direct-publishing', 'source-authority'],
  ...
  },
  {
    ...
    summary: 'The repository backs up Scripting News nightly and uses issues for discussion with readers. Publishing, preservation, and reader response happen in one public place.',
  ...
  },
  {
    ...
    summary: 'FeedLand makes a feed-reading and database toolkit available as public source. The infrastructure for following direct sources can itself be inspected, self-hosted, and modified.',
...
export const CONCEPTS = freeze([
  {
    ...
    question: 'Who can publish when the source no longer needs a newsroom to do it?',
