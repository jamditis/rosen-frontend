...
export const RECORDS = freeze([
  ...
  },
  {
    ...
    summary: 'Responding to a familiar critique of blogs, Winer reverses the frame: a blogger may not merely cite sources but may be the source speaking in public. This curated trail treats that distinction as a precursor to the later formulation.',
  ...
  },
  {
    ...
    summary: 'Winer includes “Sources go direct” among the enduring mottos that orient his work. On the same page he credits Rosen’s thinking about voice and authority, making the intellectual exchange visible in both directions.',
    themes: ['direct-publishing', 'source-authority'],
  ...
  },
  {
    ...
    summary: 'The repository backs up Scripting News nightly and uses issues for discussion with readers. Publishing, preservation, and participation become inspectable parts of the same public workflow.',
...
export const TRAIL_STOPS = freeze([
  {
    ...
    interpretation: 'The trail begins with a practical design choice: publishing software can leave the writer in control of the underlying material. Directness starts here as an arrangement between a person, a tool, and their data.',
  ...
  },
  {
    ...
    interpretation: 'The networked beat supplies that practice: listen to knowledgeable people who publish in public, then verify and connect their work. Direct sources do not remove the journalist; they alter what attentive reporting includes.',
  ...
  },
  {
    ...
    transition: 'With publishing, reporting practice, and provenance in view, the final record asks what these pieces could mean at the scale of a local institution.',
  },
  {
    id: 'institution',
    ...
    transition: 'The trail ends with a proposal, not a verdict: a user-controlled publishing idea has become one ingredient in imagining community news.',
  },
]);
...
export const CONCEPTS = freeze([
  ...
  },
  {
    ...
    explanation: 'A networked beat treats direct sources as part of the reporter’s field of attention. In this telling, the journalistic work is not displaced. It expands to include finding, checking, connecting, and contextualizing public contributions.',
...
export const CURATOR_FINDINGS = freeze([
  ...
  },
  {
    ...
    text: 'More public voices do not automatically produce a useful information environment. The corpus repeatedly asks how credible experts are found, followed, and connected—from a reader request in 2009 to feed and blogroll infrastructure.',
    evidenceRecordIds: ['direct-2009-tech-heroes', 'direct-2023-feedland', 'direct-2024-social-blogroll'],
  },
  {
    id: 'infrastructure',
...
export const MANIFEST = freeze({
  ...
  scope: 'A deliberately small demonstration corpus, not a comprehensive Dave Winer archive.',
  frozenOn: '2026-07-18',
