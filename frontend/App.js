...
import { fetchCoreData, fetchRecordDetails, preloadDetails, loadSearchIndex } from './services/archiveService.js?v=3.8.36';
import { perfMark, perfMeasure } from './utils/perfMark.js?v=3.8.36';
import { withViewTransition } from './utils/viewTransition.js?v=3.8.36';
import { CONTENT_TYPE_OPTIONS, ITEMS_PER_PAGE, REPORT_CONFIG } from './constants.js?v=3.8.36';
import { ROUTES, getCurrentRoute, getDesktopAppIdFromUrl, getEntityIdFromUrl, navigateTo, navigateToDesktop, getRecordIdFromUrl, migrateLegacyUrl } from './services/router.js?v=3.8.36';
import { parseViewState, viewStateToUrl } from './services/viewState.js?v=3.8.36';
import { ABOUT_PRIVACY_HASH, getPrivacyDetailsHref, resolvePrivacyRoute } from './services/privacyRoute.js?v=3.8.36';
import { canonicalRecordUrl, setRecordParam } from './utils/recordDeepLink.js?v=3.8.36';
import {
...
} from './utils/easterEggs.js?v=3.8.36';
import { readReportDeepLink } from './utils/reportDeepLink.js?v=3.8.36';
import { resolveSitePath } from './utils/pathResolver.js?v=3.8.36';
import { recordNeedsReview } from './utils/needsReview.js?v=3.8.36';
import {
  buildSearchText,
...
import { sortRecords } from './utils/recordSort.js?v=3.8.36';
import {
  DEFAULT_SORT,
  RELEVANCE_SORT,
  buildSearchRanking,
...
} from './utils/searchRanking.js?v=3.8.36';
import {
  requestSemanticSearch,
  terminateSemanticSearch,
  warmupSemanticSearch,
} from './services/semanticSearch.js?v=3.8.36';
import { deriveFacetsForRecords, intersectByRecordIds } from './services/queryComposition.js?v=3.8.36';
import { formatReleaseDate, loadReleaseMetadata } from './services/releaseMetadata.js?v=3.8.36';
import Sidebar from './components/Sidebar.js?v=3.8.36';
import WelcomeModal from './components/WelcomeModal.js?v=3.8.36';
import RecordView from './components/RecordView.js?v=3.8.36';
import FeaturedSection from './components/FeaturedSection.js?v=3.8.36';
import DissertationPage from './components/DissertationPage.js?v=3.8.36';
import ToolsModal from './components/ToolsModal.js?v=3.8.36';
import BugReportModal from './components/BugReportModal.js?v=3.8.36';
import WorkInProgressBanner from './components/WorkInProgressBanner.js?v=3.8.36';
import AnalyticsDashboard from './components/AnalyticsDashboard.js?v=3.8.36';
import EntityBrowser from './components/EntityBrowser.js?v=3.8.36';
import Timeline from './components/Timeline.js?v=3.8.36';
import AboutPage from './components/AboutPage.js?v=3.8.36';
import WikiPage from './components/WikiPage.js?v=3.8.36';
import StartHerePage from './components/StartHerePage.js?v=3.8.36';
import ArchiveResults from './components/ArchiveResults.js?v=3.8.36';
import EasterEggNote from './components/EasterEggNote.js?v=3.8.36';
import NowherePage from './components/NowherePage.js?v=3.8.36';
import SemanticSearchToggle, { semanticStatusMessage } from './components/SemanticSearchToggle.js?v=3.8.36';

const DesktopShell = lazy(() => import('./desktop/DesktopShell.js?v=3.8.36'));
