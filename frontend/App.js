...
import Sidebar from './components/Sidebar.js?v=3.4.9';
import WelcomeModal from './components/WelcomeModal.js?v=3.4.9';
import RecordView from './components/RecordView.js?v=3.4.9';
...
import EntityBrowser from './components/EntityBrowser.js?v=3.4.9';
import Timeline from './components/Timeline.js?v=3.4.9';
import AboutPage from './components/AboutPage.js?v=3.4.9';
import WikiPage from './components/WikiPage.js?v=3.4.9';
