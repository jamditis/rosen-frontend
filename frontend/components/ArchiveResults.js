...
import { COLORS } from '../constants.js?v=3.8.28';
import { hashString } from '../services/archiveService.js?v=3.8.28';
import { recordNeedsReview } from '../utils/needsReview.js?v=3.8.28';
import { canonicalRecordUrl } from '../utils/recordDeepLink.js?v=3.8.28';
import LoadingQuotes from './LoadingQuotes.js?v=3.8.28';
