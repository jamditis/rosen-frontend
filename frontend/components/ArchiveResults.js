...
import { COLORS } from '../constants.js?v=3.8.23';
import { hashString } from '../services/archiveService.js?v=3.8.23';
import { recordNeedsReview } from '../utils/needsReview.js?v=3.8.23';
import { canonicalRecordUrl } from '../utils/recordDeepLink.js?v=3.8.23';
import LoadingQuotes from './LoadingQuotes.js?v=3.8.23';
