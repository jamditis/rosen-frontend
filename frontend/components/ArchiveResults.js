...
import { COLORS } from '../constants.js?v=3.8.7';
import { hashString } from '../services/archiveService.js?v=3.8.7';
import { recordNeedsReview } from '../utils/needsReview.js?v=3.8.7';
import { canonicalRecordUrl } from '../utils/recordDeepLink.js?v=3.8.7';
import LoadingQuotes from './LoadingQuotes.js?v=3.8.7';
