...
import { COLORS } from '../constants.js?v=3.8.27';
import { hashString } from '../services/archiveService.js?v=3.8.27';
import { recordNeedsReview } from '../utils/needsReview.js?v=3.8.27';
import { canonicalRecordUrl } from '../utils/recordDeepLink.js?v=3.8.27';
import LoadingQuotes from './LoadingQuotes.js?v=3.8.27';
