...
import MindMap from './MindMap.js?v=3.7.1';
import DetailPanel from './DetailPanel.js?v=3.7.1';
import { DISSERTATION_NODES } from './dissertationData.js?v=3.7.1';
import { resolveSitePath } from '../utils/pathResolver.js?v=3.7.1';
