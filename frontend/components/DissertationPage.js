...
import MindMap from './MindMap.js?v=3.5.0';
import DetailPanel from './DetailPanel.js?v=3.5.0';
import { DISSERTATION_NODES } from './dissertationData.js?v=3.5.0';
import { resolveSitePath } from '../utils/pathResolver.js?v=3.5.0';
