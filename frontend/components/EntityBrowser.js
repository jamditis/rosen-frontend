...
import { fetchEntitiesData, getRecordsByEntity } from '../services/archiveService.js?v=3.8.31';
import { getEntityScope } from '../services/queryComposition.js?v=3.8.31';
import { COLORS, ENTITY_TYPE_CONFIG } from '../constants.js?v=3.8.31';
