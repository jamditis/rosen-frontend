...
import { fetchRecordDetails, fetchEntitiesData, areEntitiesLoaded, calculateEntityConnectionStrength, getEntitiesByRecord } from '../services/archiveService.js?v=3.8.36';
import { ThreadModal } from './ThreadModal.js?v=3.8.36';
import { splitUrlsForLinkify } from '../utils/linkify.js?v=3.8.36';
import { sanitizeHref } from '../utils/sanitizeHref.js?v=3.8.36';
import { recordNeedsReview } from '../utils/needsReview.js?v=3.8.36';
import { canonicalRecordUrl, shareRecordUrl } from '../utils/recordDeepLink.js?v=3.8.36';
import { acquireBodyScrollLock } from '../services/bodyScrollLock.js?v=3.8.36';
import { requestSemanticNeighbors, selectSemanticRecords } from '../services/semanticRecall.js?v=3.8.36';
