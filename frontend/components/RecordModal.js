...
import { fetchRecordDetails, fetchEntitiesData, areEntitiesLoaded, calculateEntityConnectionStrength, getEntitiesByRecord } from '../services/archiveService.js?v=3.8.15';
import { ThreadModal } from './ThreadModal.js?v=3.8.15';
import { splitUrlsForLinkify } from '../utils/linkify.js?v=3.8.15';
import { sanitizeHref } from '../utils/sanitizeHref.js?v=3.8.15';
import { recordNeedsReview } from '../utils/needsReview.js?v=3.8.15';
import { canonicalRecordUrl, shareRecordUrl } from '../utils/recordDeepLink.js?v=3.8.15';
