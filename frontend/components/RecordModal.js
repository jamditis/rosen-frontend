...
import { fetchRecordDetails, fetchEntitiesData, areEntitiesLoaded, calculateEntityConnectionStrength, getEntitiesByRecord } from '../services/archiveService.js?v=3.6.9';
import { ThreadModal } from './ThreadModal.js?v=3.6.9';
import { splitUrlsForLinkify } from '../utils/linkify.js?v=3.6.9';
import { sanitizeHref } from '../utils/sanitizeHref.js?v=3.6.9';
