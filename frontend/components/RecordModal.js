...
import { fetchRecordDetails, fetchEntitiesData, areEntitiesLoaded, calculateEntityConnectionStrength, getEntitiesByRecord } from '../services/archiveService.js?v=3.4.2';
import { ThreadModal } from './ThreadModal.js?v=3.4.2';
import { splitUrlsForLinkify } from '../utils/linkify.js?v=3.4.2';
