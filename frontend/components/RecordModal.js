...
import { fetchRecordDetails, fetchEntitiesData, areEntitiesLoaded, calculateEntityConnectionStrength, getEntitiesByRecord } from '../services/archiveService.js?v=3.4.8';
import { ThreadModal } from './ThreadModal.js?v=3.4.8';
import { splitUrlsForLinkify } from '../utils/linkify.js?v=3.4.8';
import { toEmbedUrl } from '../utils/bskyEmbed.js?v=3.4.8';
import { sanitizeHref } from '../utils/sanitizeHref.js?v=3.4.8';
          ...
          <div className="overflow-y-auto p-6 sm:p-10 font-body leading-relaxed space-y-8">
            <div>
                ...
                ${displayRecord.url && displayRecord.url !== '#' && html`
                  <a href=${sanitizeHref(toEmbedUrl(displayRecord.url))} target="_blank" rel="noreferrer" className="text-blue-700 hover:underline font-bold text-sm inline-flex items-center gap-1 mb-6">
