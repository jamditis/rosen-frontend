...
import { ARCHIVE_VERSION, openReportFallback } from '../utils/bugReport.js?v=3.8.22';
import { createSubmitGate } from '../utils/submitGate.js?v=3.8.22';
import { buildReportPayload, validateReport, submitReport, newReportKey } from '../utils/reportSubmit.js?v=3.8.22';
