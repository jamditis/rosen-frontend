...
import {
  ...
  shouldShowTourEntry,
  TOUR_OUTCOMES,
} from '../services/tourState.js?v=3.8.18';
import { getPrivacyDetailsHref } from '../services/privacyRoute.js?v=3.8.18';
...
const WelcomeModal = ({ onStart }) => {
  ...
  return html`
    <aside
      className="archive-panel archive-panel--accent archive-welcome-panel fixed z-40 bottom-4 right-4 w-full max-w-[calc(100vw-2rem)] sm:max-w-md"
      aria-labelledby="welcome-title"
      aria-describedby="welcome-description"
    >
      <div className="archive-welcome-panel__privacy">
        <span><strong>Privacy:</strong> No tracking cookies; local preferences.</span>
        <a href=${getPrivacyDetailsHref()} onClick=${handlePrivacy}>Details</a>
      </div>

      <div className="archive-welcome-panel__body">
        <button
