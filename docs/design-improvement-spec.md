# Rosen Archive design improvement spec

Status: Proposed

Evidence collected: July 10, 2026
...
This spec defines a focused refinement of the Jay Rosen Internet Archive. The work should make the archive easier to understand, scan, filter, navigate, and share while preserving the qualities that already make it distinctive.
...
Removing the query token must preserve search, category, era, and content-type refinements. This directly addresses issue #601.
...
- Add record-specific preview metadata and, if approved, record-card images.
