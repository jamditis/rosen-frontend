...
- the complete test suite passes 1,091 tests across 224 suites on rebased version `3.7.5`; the focused frontend suite passes 277 tests across 54 suites, and the production deploy-manifest suite passes all 40 focused tests;
