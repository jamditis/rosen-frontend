...
- the complete test suite passes 1,069 tests across 222 suites on rebased version `3.7.5`; the focused frontend suite passes 268 tests across 54 suites, and the production deploy-manifest suite passes all 40 focused tests;
