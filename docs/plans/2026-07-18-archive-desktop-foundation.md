...
- cold `#desktop/start` and `#desktop/findings` links each make one `archive-core.json` request, no duplicate corpus request, and settle at 14,059,597 decoded bytes without triggering the background details preload;
