...
- the complete test suite passes 1,101 tests across 225 suites on rebased version `3.7.5`; the focused frontend suite passes 285 tests across 55 suites, and the production deploy-manifest suite passes all 40 focused tests;
