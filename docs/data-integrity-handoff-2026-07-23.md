...
7. 29,693 social rows still lack explicit verification.
8. Fifty entities lack a first-mention record.

`npm run test:data:extraction-coverage` reports two passing and one failing
test. The ninth completion gate identifies 78 archive records with at least
500 raw-text characters and no extracted relationships. Its first sample rows
are `TUMBLR-00001`, `TUMBLR-00007`, `TUMBLR-00008`, `TUMBLR-00010`, and
`TUMBLR-00011`.
